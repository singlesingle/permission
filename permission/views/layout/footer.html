        ...
        <li>
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="/static/img/avatar1_small.jpg" alt=""></a>
                </div>
            ...
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="/static/img/avatar1.jpg" alt=""></a>
                </div>
                <div class="user-details">
            ...
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="/static/img/chat-avatar2.jpg" alt=""></a>
                </div>
                <div class="user-details">
...
<script src="/static/js/advanced-datatable/js/jquery.dataTables.min.js"></script>
