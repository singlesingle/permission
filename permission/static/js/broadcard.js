...
!function(){
    ...
    */
    $('#filter_module_all').click(function(e){
        ...
        //现改为搜索当前业务所有主机
        gridObj.dataSource.transport.read.data = {"tagid":380,"nodetype":"net_board_card"};
        gridObj.dataSource.transport.read.url = '/api/host/gethosts';
        CC.host.hostlist.init();
        $('#batRes').hide();
        $('#batDel').show();    
    ...
    CC.host.hostlist={
        ...
        events:function(){
            ...
            hostlist.element.on('click.kendoGrid', '.a-innerip', function(e){
                ...
                $.ajax({
                    url:'/page/device/broadcarddetails',
                    data:param,
                    dataType:'html',
                    method:'post',
            ...
            dataSource: {//数据源配置项           
                transport: {
                    read: {
                        ...
                        data:{'tagid':380,"nodetype":"net_board_card"},
                        method:'post',
                        dataType:"json"
                    }
                },
    ...
    */
    ...
    $('#broadcard_speed_search').click(function(){
        var content=$('#broadcard-search-textarea').val();
        /*没有输入任何值*/
        if(!content){
            return true;
        }
        ...
        gridObj.dataSource.transport.read.url = '/api/device/broadcardsearch';
        CC.host.hostlist.init();
        $('#batRes').hide();
        $('#batDel').show();
