    ...
    var privateHostQuickImport = {
        ...
        tmpEdit: function() {
            ...
            $('.save').on('click', function(event) {
                ...
                $(".tmp-row .管理IP").each(function(i){
                    if($(this).hasClass('管理IP')){
                ...
                $(".tmp-row .系统名称").each(function(i){
                    if($(this).hasClass('系统名称')){
                        if($(this).children('select').val().trim() == '') {
                            $(this).children('select').focus();
                            $(this).children('select').tooltip('show');
                            flag=false;
                        }else{
                            haveHostFlag = true;
                            manager.push($(this).children('select').val().trim());
                        }
                    }
                });
                if(!flag){
