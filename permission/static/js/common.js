...
$(function(){
    /*  顶栏搜索文本域触发下拉事件 */
    $('.host-search-textarea').focus(function(){
        $(this).addClass('search-textarea-down');
    }).blur(function(){
        $(this).removeClass('search-textarea-down');
    });

    $('.net-device-search-textarea').focus(function(){
        $(this).addClass('search-textarea-down');
    }).blur(function(){
        $(this).removeClass('search-textarea-down');
    });

    $('.broadcard-search-textarea').focus(function(){
        $(this).addClass('search-textarea-down');
    }).blur(function(){
        $(this).removeClass('search-textarea-down');
    });
    ...
    $('.host-search-textarea').click(function(){
        $(this).attr('placeholder','i:内网IP / h:服务器域名/ z:资产编号/ m:管理员');
    });

    $('.host-search-textarea').blur(function(){
        var value = $(this).val();
        if(!value){
    ...
    $('.net-device-search-textarea').click(function(){
        $(this).attr('placeholder','i:管理ip / x:序列号 / z:资产编号 ');
    });

    $('.net-device-search-textarea').blur(function(){
        var value = $(this).val();
        if(!value){
            $(this).attr('placeholder','快速查询');
        }
    ...
    $('.broadcard-search-textarea').click(function(){
        $(this).attr('placeholder','s: 所属设备 / x:序列号 / z:资产编号 ');
    });

    $('.broadcard-search-textarea').blur(function(){
        var value = $(this).val();
        if(!value){
            $(this).attr('placeholder','快速查询');
        }
